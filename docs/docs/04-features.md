...
Add the `@hisystems/snowpack-plugin-dotenv` plugin to your dev environment to automatically load environment variables from your project `.env` files. Visit the [plugin README](https://github.com/pikapkg/snowpack/tree/master/plugins/plugin-dotenv) to learn more.
...
- React: [@hisystems/snowpack-plugin-react-refresh](https://www.npmjs.com/package/@hisystems/snowpack-plugin-react-refresh)
